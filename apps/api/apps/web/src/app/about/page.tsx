      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 rounded-3xl bg-[var(--surface)]/95 p-8 shadow-sm ring-1 ring-[var(--border)]/80 backdrop-blur">
        ...
        <section className="space-y-4">
          ...
          <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300">
            <li>
              <span className="font-medium text-slate-700 dark:text-slate-200">Agentes especializados:</span>{" "}
            ...
            <li>
              ...
              utilizamos um orquestrador com recuperação de contexto para fornecer respostas fiéis e referenciadas.
            </li>
            <li>
              <span className="font-medium text-slate-700 dark:text-slate-200">Interface moderna:</span>{" "}
              experiência web em Next.js com modo seguro e autenticação por JWT.
            </li>
            <li>
              <span className="font-medium text-slate-700 dark:text-slate-200">Infra pronta para produção:</span>{" "}
        ...
        <section className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
          ...
          <p>
            Projeto desenvolvido por entusiastas de tecnologia e teologia. Para sugestões ou parcerias, entre em contato pelo e-mail{" "}
            <a
